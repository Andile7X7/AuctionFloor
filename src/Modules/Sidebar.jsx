...
import { FaThLarge, FaCar, FaGavel, FaWallet, FaCog, FaTimes, FaRegHeart, FaBookmark } from 'react-icons/fa';
...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    { title: 'Auction Floor', icon: <FaThLarge className={styles.navIcon} />, path: '/' },
    ...
    { title: 'Settings', icon: <FaCog className={styles.navIcon} />, path: '#' },
  ];
